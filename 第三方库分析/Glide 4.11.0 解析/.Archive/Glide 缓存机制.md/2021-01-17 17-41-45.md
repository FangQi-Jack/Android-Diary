...
```
所以在 DataCacheGenerator 的 startNext 方法中执行 `loadData.fetcher.loadData(helper.getPriority(), this);` 最终执行的是 ByteBufferFileLoader 的内部类 ByteBufferFetcher 的 loadData 方法，其中将 File 读取成 ByteBuffer 并回调了 onDataReady，这里的ca
